...
var defaultCompiledTemplatesFile = entryPath + 'app/templates/compiledTemplates'

var assert = require('assert')
  , templateAdapter = require('../../index')({entryPath: entryPath, compiledTemplatesFile: defaultCompiledTemplatesFile});
